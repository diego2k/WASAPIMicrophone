...
using namespace WASAPIMicrophone;
...
void MainPage::OnDeviceStateChange(Object^ sender, DeviceStateChangedEventArgs^ e)
{
...
void MainPage::Start_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    ...
    // Register for events
    m_deviceStateChangeToken = DeviceStateChangedEvent::StateChangedEvent += ref new DeviceStateChangedHandler(this, &MainPage::OnDeviceStateChange);
    m_audioDataReadyToken = AudioDataReadyEvent::AudioDataReady += ref new AudioDataReadyHandler(this, &MainPage::OnAudioDataReady);

    // Perform the initialization
    m_spCapture->InitializeAudioDeviceAsync();
}

void MainPage::Stop_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    if (m_spCapture)
    {
...
void MainPage::Finish_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    if (m_spCapture)
    {
